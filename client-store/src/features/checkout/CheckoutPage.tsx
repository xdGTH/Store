...
export default function CheckoutPage() {
    ...
    switch (step) {
      ...
      case 2:
        return (
          <PaymentForm
            cardState={cardState}
            onCardInputChange={onCardInputChanged}
          />
        );
      default:
    ...
    try {
      ...
      if (paymentResult.paymentIntent?.status === "succeeded") {
        const orderNumber = await agent.Orders.create({
          //these names must match the DTO properties name
  ...
  return (
    // Anything inside a FormProvider is now will be stored inside a context
